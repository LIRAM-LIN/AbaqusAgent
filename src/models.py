...
""" src/models.py defines Pydantic data models that serve as typed input/output schemas
    for service functions and MCP adapter endpoints.
    These are not ML models. They are data contracts such as:
